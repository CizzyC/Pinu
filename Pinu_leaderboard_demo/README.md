...
- 周结算反馈：模拟自然周结算后展示上周排名、上周 XP、较上周 XP 变化幅度和获得的头像框奖励。
- 头像框发放和自动佩戴：模拟 V1.0 自动发放、自动领取、自动佩戴优秀头像框，并同步到榜单本人行和个人档案。
- 个人档案：展示昵称、头像、当前头像框、本周 XP、累计 XP、当前佩戴头像框和最近获得头像框。
...
- 在周结算反馈页点击「继续」，播放金黄色奖章头像框盖章落入、冲击波和碎金点动画；动画完成后返回学习路径。
- 点击排行榜本人行或本人固定条，可进入个人档案查看当前佩戴头像框。
